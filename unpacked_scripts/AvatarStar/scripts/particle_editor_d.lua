...
function InitEmitterList()
  emitter_window = Gui.Create(gui)({
    Gui.WindowUI("root")({
      ...
      Gui.Button("OpenParticle")({
        Location = Vector2(45, 15),
        Size = Vector2(45, 30),
        Text = "DK"
      }),
      Gui.Button("ModifyParticle")({
        Location = Vector2(90, 15),
        Size = Vector2(45, 30),
        Text = "XG"
      }),
      Gui.Button("SaveParticle")({
        Location = Vector2(135, 15),
        Size = Vector2(45, 30),
        Text = "BC"
      }),
      Gui.Button("Reset")({
      ...
      Gui.Button("DeleteEmitter")({
        Location = Vector2(45, 40),
        Size = Vector2(45, 30),
        Text = "SC"
      }),
      Gui.Button("MoveUp")({
        Location = Vector2(90, 40),
        Size = Vector2(45, 30),
        Text = "SY"
      }),
      Gui.Button("MoveDown")({
        Location = Vector2(135, 40),
        Size = Vector2(45, 30),
        Text = "XY"
      }),
      Gui.Button("Camera")({
        Location = Vector2(180, 40),
        Size = Vector2(45, 30),
        Text = "XJ"
      })
    })
  ...
  function emitter_window.NewParticle.EventClick(sender, e)
    input_window.label.Text = "input particle name:"
  ...
  function emitter_window.OpenParticle.EventClick(sender, e)
    input_window.label.Text = "input particle file name:"
    input_window.root.Visible = true
  ...
  function emitter_window.NewEmitter.EventClick(sender, e)
    input_window.label.Text = "input laucher name:"
    input_window.root.Visible = true
