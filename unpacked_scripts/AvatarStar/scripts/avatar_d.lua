...
local insertBuyIndex = 2
local buyCardCostType, ComPersonCB = {}, nil
...
local ComSmTab, ComPriceCheckItem = function(name, hint, size, lc, skin)
...
function ComPriceCheckItem(name, lc)
  return Gui.Control("item_" .. name)({
    Size = Vector2(150, 31),
    Location = lc,
    Visible = false,
    ComFuc.ComLabel("cost_" .. name, "0 ", Vector2(122, 31), Vector2(28, 0), 255, 16, coly, "kAlignRightMiddle", SkinF.avatar_main_086),
    ComFuc.ComControl("icon_" .. name, Vector2(30, 30), Vector2(32, 1), 255, SkinF.avatar_main_088[1]),
    ComFuc.ComCheckBox("sel_" .. name, nil, Vector2(24, 24), Vector2(0, 4), 0, nil, "Gui.CheckBox_01")
  })
end
...
ui = Gui.Create()({
  Gui.Control("avatar_root_p")({
    ...
    Gui.Control("avatar_root")({
      ...
      Gui.Control("avatar_mid")({
        ...
        ComFuc.ComControl(nil, Vector2(716, 43), Vector2(9, 8), 255, SkinF.avatar_main_090),
        Gui.Control("price_tip")({
          Size = Vector2(716, 47),
          Location = Vector2(9, 639),
          Gui.Control({
            Size = Vector2(702, 44),
            Location = Vector2(7, 0),
            BackgroundColor = ARGB(200, 255, 255, 255),
            Skin = SkinF.personalInfo_068,
            ComFuc.ComLabel(nil, GetUTF8Text("UI_avatar_Card_Cost"), Vector2(180, 30), Vector2(50, 7), 0, 16, colw),
            ComFuc.ComControl("price_icon_1", Vector2(30, 30), Vector2(220, 7), 255, SkinF.avatar_main_088[1], false),
            ComFuc.ComControl("price_icon_2", Vector2(30, 30), Vector2(330, 7), 255, SkinF.avatar_main_088[2], false),
            ComFuc.ComControl("price_icon_3", Vector2(30, 30), Vector2(440, 7), 255, SkinF.avatar_main_088[4], false),
            ComFuc.ComControl("price_icon_4", Vector2(30, 30), Vector2(550, 7), 255, SkinF.avatar_main_088[5], false),
            ComFuc.ComLabel("price_tip_1", "0 ", Vector2(140, 30), Vector2(255, 7), 0, 16, colw, nil, nil, false),
            ComFuc.ComLabel("price_tip_2", "0 ", Vector2(140, 30), Vector2(365, 7), 0, 16, colw, nil, nil, false),
            ComFuc.ComLabel("price_tip_3", "0 ", Vector2(140, 30), Vector2(475, 7), 0, 16, colw, nil, nil, false),
            ComFuc.ComLabel("price_tip_4", "0 ", Vector2(140, 30), Vector2(585, 7), 0, 16, colw, nil, nil, false)
          }),
          ComFuc.ComControl(nil, Vector2(80, 43), Vector2(0, 4), 255, SkinF.avatar_main_091),
          ComFuc.ComControl(nil, Vector2(80, 43), Vector2(636, 4), 255, SkinF.avatar_main_092)
        }),
  ...
  Gui.Control("main_edit")({
    ...
    ComFuc.SecMainTabBtn("btn_main_1", GetUTF8Text("id_datalist_Skin") .. "   ", Vector2(86, 38), Vector2(27, 49), "menu2nd"),
    ComFuc.SecMainTabBtn("btn_main_2", GetUTF8Text("id_datalist_Head") .. "   ", Vector2(86, 38), Vector2(92, 49), "menu2nd"),
    ComFuc.SecMainTabBtn("btn_main_3", GetUTF8Text("UI_avatar_avatar_UI_02") .. "   ", Vector2(86, 38), Vector2(160, 49), "menu2nd"),
    ComFuc.SecMainTabBtn("btn_main_4", GetUTF8Text("id_datalist_Tattoo") .. "   ", Vector2(86, 38), Vector2(228, 49), "menu2nd"),
    ComFuc.SecMainTabBtn("btn_main_5", GetUTF8Text("UI_profession_Accessories") .. "   ", Vector2(86, 38), Vector2(296, 49), "menu2nd"),
  ...
  Gui.Control("finish_person_card")({
    ...
    Skin = SkinF.personalInfo_098,
    Gui.Control({
      Size = Vector2(391, 381),
      Location = Vector2(9, 9),
      BackgroundColor = colw,
      Skin = SkinF.personalInfo_206,
      ComFuc.ComLabel(nil, "  " .. GetUTF8Text("UI_avatar_avatar_UI_03"), Vector2(383, 21), Vector2(4, 4), 0, 16, colw),
      Gui.Control({
        Size = Vector2(383, 342),
        Location = Vector2(4, 33),
        BackgroundColor = colw,
        Skin = SkinF.battle_005,
        ComFuc.ComTextBox("nameCard", nil, Vector2(167, 34), Vector2(107, 9), 14),
        Gui.Control({
          Size = Vector2(104, 163),
          Location = Vector2(134, 40),
          BackgroundColor = colw,
          Skin = SkinF.personalInfo_143,
          ComFuc.ComCharacterStaticCard(nil, 1, false, false)
        }),
        ComFuc.ComLabel(nil, GetUTF8Text("UI_store_Consume"), Vector2(38, 24), Vector2(66, 203), 0, 16, colt),
        ComPriceCheckItem("last_1", Vector2(114, 199)),
        ComPriceCheckItem("last_2", Vector2(114, 234)),
        ComPriceCheckItem("last_3", Vector2(114, 269)),
        ComPriceCheckItem("last_4", Vector2(114, 304))
      })
    }),
    Gui.Control({
      Size = Vector2(391, 198),
      Location = Vector2(9, 402),
      BackgroundColor = colw,
      Skin = SkinF.personalInfo_206,
    ...
    ComFuc.ComBtnHasPreIcon("buy_card_2", "      " .. GetUTF8Text("UI_store_OK_Buy"), Vector2(130, 57), Vector2(48, 48), Vector2(132, 610), 16, false, true, SkinF.avatar_main_089, SkinF.avatar_mian_087[5], 10),
    ComFuc.ComBtnHasPreIcon("btn_pre", "      " .. GetUTF8Text("button_common_Cancel"), Vector2(130, 57), Vector2(48, 48), Vector2(268, 610), 16, false, true, SkinF.select_character_038, SkinF.avatar_mian_087[3], 10)
  }),
  ...
  Gui.Control("main_top_3")({
    Size = Vector2(356, 34),
    Location = Vector2(0, 7),
    ComSmTab("btn_dress_1", "无无", Vector2(0, 0), Vector2(0, 0), SkinF.avatar_main_076),
  ...
  Gui.Control("insertTip_m")({
    Dock = "kDockFill",
    ComFuc.ComControl("insertTip_di", Vector2(376, 196), Vector2(12, 0), 255, SkinF.battle_005),
    ComFuc.ComButton("insertTip_buy", GetUTF8Text("button_common_OK"), Vector2(84, 44), Vector2(93, 206)),
    ComFuc.ComButton("insertTip_canc", GetUTF8Text("button_common_Cancel"), Vector2(84, 44), Vector2(223, 206)),
    ComFuc.ComLabel("insertTip_text", "", Vector2(340, 76), Vector2(30, 112), 0, 16, cols, "kAlignCenterMiddle"),
    ComPriceCheckItem("pop_1", Vector2(113, 10)),
    ComPriceCheckItem("pop_2", Vector2(113, 46)),
    ComPriceCheckItem("pop_3", Vector2(113, 82)),
    ComPriceCheckItem("pop_4", Vector2(113, 118))
  }),
  ComFuc.PopControl("insertTip", Vector2(400, 304), GetUTF8Text("UI_avatar_avatar_UI_06"), 40, 1),
...
local ShowFinishCard, ShowInsertTip = function()
  ...
  ShowCreateAndCancel(false)
  if bit.band(64, ComFuc.leadList) == 64 then
    NewLead.ShowNewLeadNoLock(Vector2(878, 207), Vector2(164, 40), GetUTF8Text("UI_common_Enter_Card_Name"), 0)
  end
...
local ShowInsertTip, HideInsertTip = function(i)
  ...
  for i = 1, 4 do
    if ui["sel_pop_" .. i].Check then
      if buyCardCostType[i] == 1 then
        ui.insertTip_text.Text = string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_Gold"))
      elseif buyCardCostType[i] == 2 then
        ui.insertTip_text.Text = string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_CC"))
      elseif buyCardCostType[i] == 4 then
        ui.insertTip_text.Text = string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_Ticket"))
      else
        ui.insertTip_text.Text = string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_datalist_free_card_item"))
      end
    end
  end
...
local SetTempMsg, SetEditMsg = function(i)
  tempId = i
end, ComFuc.PopControl("insertTip", Vector2(400, 304), GetUTF8Text("UI_avatar_avatar_UI_06"), 40, 1)
...
local ManageBtn2Click, DealSysAvatarPartList = function()
  ...
  if currentPart == 1 then
    ag:SetBaseBodyTex(currentPart, "onecolor_skin", 1, Vector4(0.7, 0.7, 0.7, 1), Vector4(0.5, 0.5, 0.5, 1), Vector4(0.5, 0.5, 0.5, 1))
  elseif 2 <= currentPart and currentPart <= 4 then
...
local DealSysAvatarPartList, SetCurrAvatarPart = function(data)
  ...
  dataList = data.list
  searhPositon = data.position or 0
...
local SetHeadTabpad, SetDressTabpad = function(i)
  if i <= 5 then
    ag:SetLookAtAvatarPart("kAvatarHead")
  else
    ag:SetLookAtAvatarPart("kAvatarBody")
  end
  for k = 1, 7 do
    ui["btn_head_" .. k].PushDown = k == i
  end
...
local SetDressTabpad, SetDecalTabpad = function(i)
  if 2 == i then
    ag:SetLookAtAvatarPart("kAvatarChest")
  elseif 3 == i or 5 == i then
    ag:SetLookAtAvatarPart("kAvatarHip")
  elseif 4 == i then
    ag:SetLookAtAvatarPart("kAvatarHand")
  end
  for k = 1, 5 do
    ui["btn_dress_" .. k].PushDown = k == i
  end
...
local SetTrinketTabpad, GoShowLayer = function(i)
  ...
  for k = 1, 4 do
    ui["btn_trinket_" .. k].PushDown = k == i
  end
...
local DealPersonalCardList, ShowPersonCard = function(data)
  ...
  for i, v in ipairs(data.items) do
    local t = i + 1
    cardDt[t] = v
    ui["person_b_" .. t].PushDown = selectPersonId == v.pid
    ShowOnePersonCard(t, true)
    ComFuc.SetPersonCardDataARoom(v.avatar, t, v.position)
...
local SelCurrPosBtn, SetPosPageEnable = function()
  for k = 1, 8 do
    ui["posture_" .. k .. "_b"].PushDown = k == postureCurr
    ui["posture_" .. k .. "_c"].Visible = k == postureCurr
  end
end, ComFuc.ComControl("strawControl", Vector2(32, 32), Vector2(0, 0), 255, SkinF.avatar_main_044)
local SetPosPageEnable, SetPostrueIcon = function()
  ui.btn_pre_pos.Enable = postureBegin ~= 1
  ui.btn_next_pos.Enable = postureBegin + 7 < #postureList
end, ComFuc.ComControl("strawControl", Vector2(32, 32), Vector2(0, 0), 255, SkinF.avatar_main_044)
...
local DealPoseList, RecoverLayerButton = function(data)
  for i = 1, 4 do
    ui["sel_pop_" .. i].Check = i == 1
    ui["sel_last_" .. i].Check = i == 1
  end
  local k = 0
  if data.price then
    for i, v in ipairs(data.price) do
      if 0 < v.currency and 0 < v.num then
        k = k + 1
        buyCardCostType[k] = v.currency
        ui["price_icon_" .. k].Visible = true
        ui["price_tip_" .. k].Visible = true
        ui["item_pop_" .. k].Visible = true
        ui["item_last_" .. k].Visible = true
        ui["price_tip_" .. k].Text = v.num .. " "
        ui["cost_pop_" .. k].Text = v.num .. " "
        ui["cost_last_" .. k].Text = v.num .. " "
        ui["price_icon_" .. k].Skin = SkinF.avatar_main_088[v.currency]
        ui["icon_pop_" .. k].Skin = SkinF.avatar_main_088[v.currency]
        ui["icon_last_" .. k].Skin = SkinF.avatar_main_088[v.currency]
      end
    end
  end
  if data.activeNum and 0 < data.activeNum then
    k = k + 1
    buyCardCostType[k] = data.activeNum
    ui["price_icon_" .. k].Visible = true
    ui["price_tip_" .. k].Visible = true
    ui["item_pop_" .. k].Visible = true
    ui["item_last_" .. k].Visible = true
    ui["price_tip_" .. k].Text = data.activeNum .. " "
    ui["cost_pop_" .. k].Text = data.activeNum .. " "
    ui["cost_last_" .. k].Text = data.activeNum .. " "
    ui["price_icon_" .. k].Skin = SkinF.avatar_main_088[5]
    ui["icon_pop_" .. k].Skin = SkinF.avatar_main_088[5]
    ui["icon_last_" .. k].Skin = SkinF.avatar_main_088[5]
  end
  for i = k + 1, 4 do
    ui["price_icon_" .. i].Visible = false
    ui["price_tip_" .. i].Visible = false
    ui["item_pop_" .. i].Visible = false
    ui["item_last_" .. i].Visible = false
  end
  ui.insertTip.Size = Vector2(400, 196 + 36 * k)
  ui.insertTip_son.Size = Vector2(400, 196 + 36 * k - 40)
  ui.insertTip_di.Size = Vector2(376, 88 + 36 * k)
  ui.insertTip_buy.Location = Vector2(93, 98 + 36 * k)
  ui.insertTip_canc.Location = Vector2(223, 98 + 36 * k)
  ui.insertTip_text.Location = Vector2(30, 4 + 36 * k)
...
local SaveSuit, DeleteSuit = function()
  ...
  local des, n = string.gsub(GetUTF8Text("msgbox_common_conditionkey_155"), "{" .. tostring(0) .. "}", SelectCharacter.role_text)
  local costType = 30
  for i = 1, 4 do
    if ui["sel_last_" .. i].Check then
      costType = buyCardCostType[i]
      break
    end
  end
  local IsCostActiveItem = "N"
  if costType == 30 then
    IsCostActiveItem = "Y"
    costType = nil
  end
  if not partIdList or partIdList == "" or partIdList == " " then
    ...
    rpc.safecall("player_avatar_save", {
      ...
      description = des,
      costActiveItem = IsCostActiveItem,
      currency = costType,
      ids = partIdList,
      buy = isSuitBuy,
      name = tnct,
...
local SelMainBtn, DealPesonalCardEdit = function(i)
  ...
  for j = 1, 5 do
    ui["btn_main_" .. j].Parent = j ~= i and ui.main_edit
  end
  ui["btn_main_" .. i].Parent = ui.main_edit
end, ComFuc.ComControl("strawControl", Vector2(32, 32), Vector2(0, 0), 255, SkinF.avatar_main_044)
...
for i = 1, 4 do
  ui["sel_last_" .. i].EventCheckChanged = function(sender, e)
    if "kTriggerMouse" == e.Trigger then
      for k = 1, 4 do
        ui["sel_last_" .. k].Check = i == k
      end
    end
  end
end
for i = 1, 4 do
  ui["sel_pop_" .. i].EventCheckChanged = function(sender, e)
    if "kTriggerMouse" == e.Trigger then
      for k = 1, 4 do
        ui["sel_pop_" .. k].Check = i == k
      end
    end
    if buyCardCostType[i] == 1 then
      ui.insertTip_text.Text = string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_Gold"))
...
function ui.buy_card_2.EventClick(sender, e)
  ...
  for i = 1, 4 do
    if ui["sel_last_" .. i].Check then
      if buyCardCostType[i] == 1 then
        MessageBox.ShowWithConfirmCancel(string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_Gold")), SaveSuit)
        break
      end
      if buyCardCostType[i] == 2 then
        MessageBox.ShowWithConfirmCancel(string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_CC")), SaveSuit)
        break
      end
      if buyCardCostType[i] == 4 then
        MessageBox.ShowWithConfirmCancel(string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_common_Ticket")), SaveSuit)
        break
      end
      MessageBox.ShowWithConfirmCancel(string.format(GetUTF8Text("msgbox_common_num_1182"), tonumber(ui["cost_pop_" .. i].Text), GetUTF8Text("id_datalist_free_card_item")), SaveSuit)
      break
    end
  end
end
...
local MoveUiFromLobby, RecoverUiToLooby = function()
  ...
  Lobby.ui.ctl_online_root.Parent = ui.avatar_root
  Lobby.ui.btn_chatUnShow.Parent = ui.avatar_root
  Lobby.ui.btn_activity.Parent = ui.avatar_root
  Lobby.ui.btn_rankArmy.Parent = ui.avatar_root
  ...
  Lobby.ui.topHead_b.Parent = ui.avatar_root
  ...
  Lobby.ui.stretch_public.Parent = ui.avatar_root
  ...
  Lobby.ui.buf_list.Parent = ui.avatar_root
  Lobby.ui.run_num.Parent = ui.avatar_root
  Lobby.ui.hook_num.Parent = ui.avatar_root
  Lobby.ui.rank_point.Parent = ui.avatar_root
  Lobby.ui.no_speak.Parent = ui.avatar_root
  Lobby.ui.vip_info.Parent = ui.avatar_root
  ...
  Lobby.ui.sign_f.Parent = ui.avatar_root
  Lobby.ui.partc3.Parent = ui.avatar_root
  Lobby.ui.partc4.Parent = ui.avatar_root
  Lobby.ui.tlbl_online.Timer = 1
  Lobby.ui.tlbl_online:Start()
end, "EventClick"

function RecoverUiToLooby()
  Lobby.ui.btn_money.Parent = Lobby.ui.lobby_root
  Lobby.ui.btn_receive.Parent = Lobby.ui.lobby_root
  Lobby.ui.btn_activity.Parent = Lobby.ui.lobby_root
  Lobby.ui.btn_rankArmy.Parent = Lobby.ui.lobby_root
  Lobby.ui.btn_sign.Parent = Lobby.ui.lobby_root
  Lobby.ui.ctl_online_root.Parent = Lobby.ui.lobby_root
  ...
  Lobby.ui.topHead_b.Parent = Lobby.ui.lobby_root
  ...
  Lobby.ui.stretch_public.Parent = Lobby.ui.lobby_root
  ...
  Lobby.ui.buf_list.Parent = Lobby.ui.lobby_root
  Lobby.ui.run_num.Parent = Lobby.ui.lobby_root
  Lobby.ui.hook_num.Parent = Lobby.ui.lobby_root
  Lobby.ui.rank_point.Parent = Lobby.ui.lobby_root
  Lobby.ui.no_speak.Parent = Lobby.ui.lobby_root
  Lobby.ui.vip_info.Parent = Lobby.ui.lobby_root
  ...
  Lobby.ui.sign_f.Parent = Lobby.ui.lobby_root
  Lobby.ui.partc3.Parent = Lobby.ui.lobby_root
  Lobby.ui.partc4.Parent = Lobby.ui.lobby_root
  Lobby.ui.tlbl_online:Stop()
end
...
function Show()
  if not Visible then
    ...
    AlignUI()
    Visible = true
    if 0 < Lobby.max_buf_end_time then
      if timer then
        TimerRemove()
      end
    ...
    if Lobby.ui.btn_m_8_c.IsGo and Lobby.ui.btn_m_8_c.IsBegin then
      ...
      Lobby.ui.partc4.Visible = true
    end
    Lobby.ui.sys_pulic.Parent = gui
  end
  Lobby.SetNewMail()
end
