...
boss:SetEffectSound("kBuffTypeQuickMeachinegun", "go/boss_3d/boss_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeQuickRpg", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeQuickRpg", "go/boss_3d/boss_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeDeadlyRpg", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeDeadlyRpg", "go/boss_3d/boss_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeCoolDownRpg", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeCoolDownRpg", "go/boss_3d/boss_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeCoolDownBow", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeCoolDownBow", "go/boss_3d/boss_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeQuickBow", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeQuickBow", "go/boss_3d/boss_lv1_conjure")
...
boss.born_sound_name = "go/boss_3d/boss_lv1_born"
boss.die_sound_name = "go/boss_3d/boss_lv1_dead"
boss.run_sound_name = "go/boss_3d/boss_lv1_runforward"
boss.idle_sound_name = "go/boss_3d/boss_lv1_idle"
boss.jump_up_sound_name = "go/boss_3d/boss_lv1_jumpup"
boss.jump_down_sound_name = "go/boss_3d/boss_lv1_jumpdown"
boss.jump_loop_sound_name = "go/boss_3d/boss_lv1_jumpshoot"
