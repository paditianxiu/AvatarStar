...
boss:SetEffectSound("kBuffTypeDamageGrenade", "go/boss_3d/boss02_lv1_conjure")
...
boss:SetEffectSound("kBuffTypeCoolDownGrenade", "go/boss_3d/boss02_lv1_conjure")
...
boss:SetEffectSound("kBuffTypeCoolDownRpg2", "go/boss_3d/boss02_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeNoHarm", "stdshield", 0.05, false)
boss:SetEffectSound("kBuffTypeNoHarm", "go/boss_3d/boss02_lv1_shield")
...
boss:SetEffectSound("kBuffTypeRecovery", "go/boss_3d/boss02_lv1_fix")
...
boss:SetEffectSound("kBuffTypeFireHurt", "go/boss_3d/boss02_lv1_conjure")
...
boss:SetEffectSound("kBuffTypeHB", "go/boss_3d/boss02_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeRpgHit", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeRpgHit", "go/boss_3d/boss02_lv1_conjure")
boss:SetEffectAnimation("kBuffTypeHighlyDamage", "stdskill002", 0.05, true)
boss:SetEffectSound("kBuffTypeHighlyDamage", "go/boss_3d/boss_lv3_faint")
...
boss.die_sound_name = "go/boss_3d/boss02_lv1_die"
boss.run_sound_name = "go/boss_3d/boss02_lv1_run"
boss.idle_sound_name = "go/boss_3d/boss02_lv1_idle"
