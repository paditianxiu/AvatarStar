...
boss:SetEffectSound("kBuffTypeQuickMeachinegun", "go/boss_3d/boss_lv2_conjure")
boss:SetEffectAnimation("kBuffTypeQuickRpg", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeQuickRpg", "go/boss_3d/boss_lv2_conjure")
boss:SetEffectAnimation("kBuffTypeDeadlyRpg", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeDeadlyRpg", "go/boss_3d/boss_lv2_conjure")
boss:SetEffectAnimation("kBuffTypeCoolDownRpg", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeCoolDownRpg", "go/boss_3d/boss_lv2_conjure")
boss:SetEffectAnimation("kBuffTypeCoolDownBow", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeCoolDownBow", "go/boss_3d/boss_lv2_conjure")
boss:SetEffectAnimation("kBuffTypeQuickBow", "stdconjure", 0.05, false)
boss:SetEffectSound("kBuffTypeQuickBow", "go/boss_3d/boss_lv2_conjure")
...
boss:SetEffectSound("kBuffTypeShieldBoss", "go/boss_3d/boss_lv2_shield")
...
boss:SetEffectSound("kBuffTypeVitalsBoss", "go/boss_3d/boss_lv2_faint")
boss:SetEffectParticle("kBuffTypeVitalsBoss", "boss_serious1_somke", "body", Vector3(0, 0, 0))
boss.born_sound_name = "go/boss_3d/boss_lv2_born"
boss.die_sound_name = "go/boss_3d/boss_lv2_dead"
boss.run_sound_name = "go/boss_3d/boss_lv2_runforward"
boss.idle_sound_name = "go/boss_3d/boss_lv2_idle"
boss.jump_up_sound_name = "go/boss_3d/boss_lv2_jumpup"
boss.jump_down_sound_name = "go/boss_3d/boss_lv2_jumpdown"
boss.jump_loop_sound_name = "go/boss_3d/boss_lv2_jumpshoot"
