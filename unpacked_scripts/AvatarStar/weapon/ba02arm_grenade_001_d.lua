weapon:SetMesh("rv", "Ba02Arm_grenade_001/Ba02Arm_grenade_001.mesh", 0)
local ActorType = {
  kSphere = 0,
  kCapsule = 1,
  kBox = 2
...
weapon.icon = texture("/ui/skinF/lobby/Ba02Arm_grenade_001.tga")
weapon.kill_icon = texture("/ui/weapon/Ba02Arm_grenade_001.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/Ba02Arm_grenade_001.tga")
weapon.cross_hair_icon = texture("/ui/weapon/grenade.dds")
weapon.explode_particle = "b2_grenade_explosino1"
weapon.trail_particle = "b2_attack_grenade_1"
