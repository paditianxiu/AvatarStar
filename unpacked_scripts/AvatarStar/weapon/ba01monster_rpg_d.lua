weapon.name = "Ba01Monster_rpg"
weapon:SetMesh("rv", "Ba01Monster_rpg/Ba01Monster_rpg.mesh")
weapon:SetMesh("mz", "Ba01Monster_rpg/Ba01Monster_rpg.mesh")
weapon.skeleton = "/skeleton/ba01monster_rpg_001.skel"
