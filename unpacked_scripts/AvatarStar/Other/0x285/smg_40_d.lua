weapon:SetMesh("rv", "smg_40/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_40/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_01.skel"
weapon.animation_set = "smg_01"
weapon.icon = texture("/ui/skinF/lobby/smg_40.tga")
weapon.kill_icon = texture("/ui/weapon/mk18_40.dds")
