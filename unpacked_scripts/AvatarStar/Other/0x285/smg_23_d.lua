weapon:SetMesh("rv", "smg_23/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_23/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_08.skel"
weapon.animation_set = "smg_08"
weapon.icon = texture("/ui/skinF/lobby/smg_23.tga")
weapon.kill_icon = texture("/ui/weapon/mk18_23.dds")
