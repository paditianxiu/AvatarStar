weapon:SetMesh("rv", "smg_13/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_13/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_01.skel"
weapon.animation_set = "smg_01"
weapon.icon = texture("/ui/skinF/lobby/smg_13.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.05, 0)
