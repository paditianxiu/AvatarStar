weapon:SetMesh("rv", "smg_21/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_21/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_09.skel"
weapon.animation_set = "smg_09"
weapon.icon = texture("/ui/skinF/lobby/smg_21.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.13, 0.17)
