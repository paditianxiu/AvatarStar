weapon:SetMesh("rv", "smg_31/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_31/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_08.skel"
weapon.animation_set = "smg_08"
weapon.icon = texture("/ui/skinF/lobby/smg_31.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.085, 0)
