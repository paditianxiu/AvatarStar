weapon:SetMesh("rv", "smg_26/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_26/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_09.skel"
weapon.animation_set = "smg_09"
weapon.icon = texture("/ui/skinF/lobby/smg_26.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.1, 0.18)
