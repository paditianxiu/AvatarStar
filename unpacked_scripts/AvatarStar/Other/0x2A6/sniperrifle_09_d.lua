weapon:SetMesh("rv", "sniperrifle_09/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_09/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_09.skel"
weapon.animation_set = "sniperrifle_09"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_09.tga")
