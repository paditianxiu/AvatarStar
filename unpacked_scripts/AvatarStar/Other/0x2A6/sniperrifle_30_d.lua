weapon:SetMesh("rv", "sniperrifle_30/rv1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_08.skel"
weapon.animation_set = "sniperrifle_08"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_30.tga")
