weapon:SetMesh("rv", "smg_45/rv1_lod0.mesh")
weapon:SetMesh("mz", "smg_45/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/smg_08.skel"
weapon.animation_set = "smg_08"
weapon.icon = texture("/ui/skinF/lobby/smg_45.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.1, 0.17)
