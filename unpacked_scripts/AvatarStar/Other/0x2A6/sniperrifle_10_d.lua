weapon:SetMesh("rv", "sniperrifle_10/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_10/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_09.skel"
weapon.animation_set = "sniperrifle_09"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_10.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.05, 0.2)
