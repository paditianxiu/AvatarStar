weapon:SetMesh("rv", "sniperrifle_13/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_13/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_01.skel"
weapon.animation_set = "sniperrifle_01"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_13.tga")
