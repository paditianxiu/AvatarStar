weapon:SetMesh("rv", "sniperrifle_20/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_20/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_09.skel"
weapon.animation_set = "sniperrifle_09"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_20.tga")
