weapon:SetMesh("rv", "sniperrifle_24/rv1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_08.skel"
weapon.animation_set = "sniperrifle_08"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_24.tga")
weapon.kill_icon = texture("/ui/weapon/mk18_24.dds")
