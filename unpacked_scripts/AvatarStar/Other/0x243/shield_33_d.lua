weapon:SetMesh("rvl", "shield_33/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "shield_33/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/shield_33.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/shield_33.tga")
