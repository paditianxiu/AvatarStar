weapon:SetMesh("rvl", "shield_38/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "shield_38/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/shield_38.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/shield_38.tga")
