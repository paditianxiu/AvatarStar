weapon:SetMesh("rvl", "shield_36/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "shield_36/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/shield_36.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/shield_36.tga")
