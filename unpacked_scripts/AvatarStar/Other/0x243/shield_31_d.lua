weapon:SetMesh("rvl", "shield_31/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "shield_31/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/shield_31.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/shield_31.tga")
