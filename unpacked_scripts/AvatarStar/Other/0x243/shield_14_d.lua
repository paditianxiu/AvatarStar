weapon:SetMesh("rvl", "shield_14/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "shield_14/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/shield_14.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/shield_14.tga")
