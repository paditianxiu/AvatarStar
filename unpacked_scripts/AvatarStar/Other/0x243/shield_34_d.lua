weapon:SetMesh("rvl", "shield_34/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "shield_34/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/shield_34.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/shield_34.tga")
