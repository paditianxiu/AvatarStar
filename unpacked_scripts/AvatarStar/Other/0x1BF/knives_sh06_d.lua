weapon:SetMesh("rvl", "knives_sh06/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "knives_sh06/rvr1_lod0.mesh")
weapon.ik_enable = false
weapon.hand_bind_type = "kHandNone"
weapon.skeleton = "/skeleton/knives_sh05.skel"
weapon.animation_set = "knives_sh05"
weapon.trail_particle = "shield_trail"
weapon.shield_trail_particle = "shield_trail"
weapon.sound_name = "werewolf"
weapon.icon = texture("/ui/skinF/lobby/knives_sh06.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/knives_sh06.tga")
