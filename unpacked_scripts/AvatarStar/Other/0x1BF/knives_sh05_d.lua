weapon:SetMesh("rvl", "knives_sh05/rvl1_lod0.mesh")
weapon:SetMesh("rvr", "knives_sh05/rvr1_lod0.mesh")
...
weapon.icon = texture("/ui/skinF/lobby/knives_sh05.tga")
weapon.ammo_icon = texture("/ui/skinF/lobby/knives_sh05.tga")
