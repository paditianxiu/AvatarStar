weapon:SetMesh("rv", "sniperrifle_45/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_45/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_09.skel"
weapon.animation_set = "sniperrifle_09"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_45.tga")
...
weapon.fire_particle_offset = Vector3(0, -0.03, 0.18)
