weapon:SetMesh("rv", "sniperrifle_42/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_42/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_01.skel"
weapon.animation_set = "sniperrifle_01"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_42.tga")
