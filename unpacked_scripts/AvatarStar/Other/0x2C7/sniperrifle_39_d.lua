weapon:SetMesh("rv", "sniperrifle_39/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_39/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_01.skel"
weapon.animation_set = "sniperrifle_01"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_39.tga")
