weapon:SetMesh("rv", "sniperrifle_34/rv1_lod0.mesh")
weapon:SetMesh("mz", "sniperrifle_34/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/sniperrifle_01.skel"
weapon.animation_set = "sniperrifle_01"
weapon.icon = texture("/ui/skinF/lobby/sniperrifle_34.tga")
