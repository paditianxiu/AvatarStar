weapon:SetMesh("rv", "grenadelauncherbullet_51/rv1_lod0.mesh", 0)
...
weapon.icon = texture("/ui/skinF/lobby/grenade_51.tga")
weapon.kill_icon = texture("/ui/weapon/grenade_51.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/grenade_51.tga")
