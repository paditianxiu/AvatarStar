weapon:SetMesh("rv", "machinegun_39/rv1_lod0.mesh")
weapon:SetMesh("mz", "machinegun_39/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/machinegun_01.skel"
weapon.animation_set = "machinegun_01"
weapon.icon = texture("/ui/skinF/lobby/machinegun_39.tga")
