weapon:SetMesh("rv", "machinegun_42/rv1_lod0.mesh")
weapon:SetMesh("mz", "machinegun_42/mz1_lod0.mesh")
weapon.skeleton = "/skeleton/machinegun_01.skel"
weapon.animation_set = "machinegun_01"
weapon.icon = texture("/ui/skinF/lobby/machinegun_42.tga")
