...
CircleBar = ImportWidget("Gui.CircleBar")
CircleContainer = ImportWidget("Gui.CircleContainer")
...
DepotWeaponUpBtn = ImportWidget("Gui.DepotWeaponUpBtn")
MoveControl = ImportWidget("Gui.MoveControl")
HasRightClickBtn = ImportWidget("Gui.HasRightClickBtn")
...
TimerLabel = ImportWidget("Gui.TimerLabel")
...
TextButton = ImportWidget("Gui.TextButton")
