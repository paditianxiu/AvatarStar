weapon:SetMesh("rv", "stick_sh01/rv1_lod0.mesh")
weapon.ik_enable = false
weapon.hand_bind_type = "kHandNone"
weapon.skeleton = "/skeleton/stick_sh01.skel"
weapon.animation_set = "stick_sh01"
weapon.icon = texture("/ui/skinF/lobby/stick_sh01.tga")
weapon.kill_icon = texture("/ui/weapon/knives_01.dds")
weapon.ammo_icon = texture("/ui/ingameF/weapon_ammo_icon/stick_sh01.tga")
weapon.cross_hair_icon = texture("/ui/weapon/knives.dds")
weapon.name = "stick_sh01"
weapon.trail_particle = "shield_trail3"
